...
public class Splash extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cache.setAppid(5); // 2 means this is maths, 1 is English , 3 is physics, 5 is Maths iGCSE
		...
		Thread timer = new Thread(){
			public void run(){
			   ...
			   // Download Configuration Files:
			    ...
			    Boolean Success1 = C.DownloadFile(cache.getServerURL() + "/mathsiGCSEConfig.xml", "mathsiGCSEConfig.xml", getApplicationContext());
			  //Boolean Success2 = C.DownloadFile("http://learnerscloud.com/iosStreamv2/maths/mathsConfig.xml", "mathsConfig.xml", getApplicationContext());
			    ...
			    Intent OpenStartPage = new Intent("com.learnerscloud.igcsemaths.videosamazon.TABS");
