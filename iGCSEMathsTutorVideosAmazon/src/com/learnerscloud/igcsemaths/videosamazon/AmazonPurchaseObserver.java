	 ...
	 // Load Items to for Price List
	    public void onSdkAvailable(final boolean isSandboxMode) {
	       ...
	       Set<String> s = new TreeSet<String>();
	        s.add("androidigcsemaths1monthAmazon");
	        s.add("androidigcsemaths3monthsAmazon");
	        s.add("androidigcsemaths6monthsAmazon");
	        s.add("androidigcsemaths9monthsAmazon");
	        s.add("androidigcsemaths12monthsAmazon");
