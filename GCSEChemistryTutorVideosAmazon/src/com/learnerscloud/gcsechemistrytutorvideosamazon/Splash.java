...
public class Splash extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cache.setServerURL("http://www.learnerscloud.com/AndroidStream/chemistry");
		cache.setServer("http://learnerscloud.com");
		cache.setVideoURL("/AndroidStream/chemistry");
		cache.setAppid(4); // 2 means this is maths, 1 is English , 3 is physics, 4 chemistry
		...
		Thread timer = new Thread(){
			public void run(){
			   ...
			   // Download Configuration Files:
			    ...
			    Boolean Success1 = C.DownloadFile(cache.getServerURL() + "/chemistryConfig.xml", "chemistryConfig.xml", getApplicationContext());
			  //Boolean Success2 = C.DownloadFile("http://learnerscloud.com/iosStreamv2/maths/mathsConfig.xml", "mathsConfig.xml", getApplicationContext());
			    ...
			    Intent OpenStartPage = new Intent("com.learnerscloud.gcsechemistrytutorvideosamazon.TABS");
