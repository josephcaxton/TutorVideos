	 ...
	 // Load Items to for Price List
	    public void onSdkAvailable(final boolean isSandboxMode) {
	       ...
	       Set<String> s = new TreeSet<String>();
	        s.add("androidchemistry1monthamazon");
	        s.add("androidchemistry3monthsamazon");
	        s.add("androidchemistry6monthsamazon");
	        s.add("androidchemistry9monthsamazon");
	        s.add("androidchemistry12monthsamazon");
