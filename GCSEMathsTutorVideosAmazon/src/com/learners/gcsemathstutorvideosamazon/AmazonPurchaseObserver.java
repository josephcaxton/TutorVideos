	 ...
	 // Load Items to for Price List
	    public void onSdkAvailable(final boolean isSandboxMode) {
	       ...
	       Set<String> s = new TreeSet<String>();
	        s.add("androidmaths1monthamazon");
	        s.add("androidmaths3monthsamazon");
	        s.add("androidmaths6monthsamazon");
	        s.add("androidmaths9monthsamazon");
	        s.add("androidmaths12monthsamazon");
