...
public class Splash extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cache.setServerURL("http://www.learnerscloud.com/AndroidStream/physics");
		cache.setServer("http://learnerscloud.com");
		cache.setVideoURL("/AndroidStream/physics");
		cache.setAppid(3); // 2 means this is maths, 1 is English , 3 is physics
		...
		Thread timer = new Thread(){
			public void run(){
			   ...
			   // Download Configuration Files:
			    ...
			    Boolean Success1 = C.DownloadFile(cache.getServerURL() + "/physicsConfig.xml", "physicsConfig.xml", getApplicationContext());
			  //Boolean Success2 = C.DownloadFile("http://learnerscloud.com/iosStreamv2/maths/mathsConfig.xml", "mathsConfig.xml", getApplicationContext());
			    ...
			    Intent OpenStartPage = new Intent("com.learnerscloud.gcsephysicstutorvideosamazon.TABS");
