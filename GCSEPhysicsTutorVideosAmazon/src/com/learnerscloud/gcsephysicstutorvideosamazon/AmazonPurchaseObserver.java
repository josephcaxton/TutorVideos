	 ...
	 // Load Items to for Price List
	    public void onSdkAvailable(final boolean isSandboxMode) {
	       ...
	       Set<String> s = new TreeSet<String>();
	        s.add("androidphysics1monthamazon");
	        s.add("androidphysics3monthsamazon");
	        s.add("androidphysics6monthsamazon");
	        s.add("androidphysics9monthsamazon");
	        s.add("androidphysics12monthsamazon");
