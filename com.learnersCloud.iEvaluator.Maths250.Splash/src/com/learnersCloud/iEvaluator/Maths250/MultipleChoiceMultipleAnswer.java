...
public class MultipleChoiceMultipleAnswer extends ActivityGroup implements OnClickListener{
	...
	Integer CorrectAnswerListCounter;
	List<String> CorrectAnswerInHTMLList;
	Integer CorrectAnswerInHTMLListCounter = 0;
	Button BtnReason;
		...
		
	{
		...
		for(int i = 0; i < ButtonArray.size(); i++){
			...
			if(Integer.parseInt(tag.toString()) == 1){
				String LastText = CorrectAnswerInHTMLList.get(CorrectAnswerInHTMLListCounter -1).toString();
				CorrectAnswerInHTMLListCounter--;
