...
import com.learnerscloud.gcsebiologytutorvideosamazon.R;
...
public class Splash extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cache.setServerURL("http://www.learnerscloud.com/AndroidStream/biology");
		cache.setServer("http://learnerscloud.com");
		cache.setVideoURL("/AndroidStream/biology");
		cache.setAppid(6); // 2 means this is maths, 1 is English , 3 is physics, 4 chemistry
		...
		Thread timer = new Thread(){
			public void run(){
			   ...
			   // Download Configuration Files:
			    ...
			    Boolean Success1 = C.DownloadFile(cache.getServerURL() + "/biologyConfig.xml", "biologyConfig.xml", getApplicationContext());
			  //Boolean Success2 = C.DownloadFile("http://learnerscloud.com/iosStreamv2/maths/mathsConfig.xml", "mathsConfig.xml", getApplicationContext());
			    ...
			    Intent OpenStartPage = new Intent("com.learnerscloud.gcsebiologytutorvideosamazon.TABS");
