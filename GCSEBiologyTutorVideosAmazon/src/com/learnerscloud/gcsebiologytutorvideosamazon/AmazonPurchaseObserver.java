	 ...
	 // Load Items to for Price List
	    public void onSdkAvailable(final boolean isSandboxMode) {
	       ...
	       Set<String> s = new TreeSet<String>();
	        s.add("androidbiology1monthamazon");
	        s.add("androidbiology3monthsamazon");
	        s.add("androidbiology6monthsamazon");
	        s.add("androidbiology9monthsamazon");
	        s.add("androidbiology12monthsamazon");
